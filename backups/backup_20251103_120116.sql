...
INSERT INTO `logs` (`id`, `event_type`, `message`, `created_at`, `source`) VALUES ('1', 'info', 'Сервер Prod-DB-01 запущен успешно', '2025-10-25 08:00:00', 'system');
INSERT INTO `logs` (`id`, `event_type`, `message`, `created_at`, `source`) VALUES ('2', 'warning', 'Высокая загрузка CPU на Web-Frontend-02 (85%)', '2025-10-25 08:30:00', 'monitoring');
INSERT INTO `logs` (`id`, `event_type`, `message`, `created_at`, `source`) VALUES ('3', 'error', 'Ошибка подключения к базе данных', '2025-10-25 09:15:00', 'application');
INSERT INTO `logs` (`id`, `event_type`, `message`, `created_at`, `source`) VALUES ('4', 'critical', 'Сбой резервного копирования на Backup-Server', '2025-10-24 02:15:00', 'backup_service');
INSERT INTO `logs` (`id`, `event_type`, `message`, `created_at`, `source`) VALUES ('5', 'info', 'Пользователь john_engineer вошёл в систему', '2025-10-25 09:05:00', 'auth');
...
INSERT INTO `users` (`id`, `username`, `password_hash`, `email`, `referral_code`, `role`, `created_at`, `password_created_at`, `avatar`, `last_verification_code_sent_at`) VALUES ('10', 'admin_user', 'hash_abc123', 'admin@company.com', NULL, 'admin', '2024-01-10 08:00:00', '2024-01-10 08:00:00', 'imang/default.png', NULL);
